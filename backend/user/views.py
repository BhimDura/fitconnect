...
from user.serializers import RegisterSerializer, UserDetailSerializer, UserSerializer
...
class GetUserDetails(APIView):
    ...
    authentication_classes = [JWTAuthentication]
    def post(self, request):
        user = request.user  # Assuming you are using token-based authentication
